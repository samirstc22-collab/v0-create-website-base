...
const articles = [
  ...
  },
  {
    ...
    excerpt:
      "Técnica autoral criada e apresentada no 20° Congresso In-Cosmetics. Combinação Glicólico 20–70%, Mandélico 45%, Retinóico 5% e Azelaico para profundidade de peeling fenol sem os riscos.",
    link: "#",
  },
  {
    cover: "b-nano",
