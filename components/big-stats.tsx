  ...
  const stats = [
    {
      ...
      sub: "aplicação real em bancada — não teoria",
      accent: "#B8783D",
      featured: true,
    },
    {
      ...
      sub: "em metodologia própria de desenvolvimento",
      accent: "#0C2340",
      featured: true,
    },
    {
      ...
      sub: "consultoria técnica especializada",
      accent: "#B8783D",
      featured: true,
    },
    {
    ...
    },
    {
      ...
      suffix: "",
      label: "Continentes",
      sub: "em missões técnicas internacionais",
      accent: "#0a8f9e",
      featured: false,
    },
  ]
